<template>
  <div class="comment-wrapper">
    <n-card class="comment-wrapper__comment" hoverable @click="(e: Event) => console.log('some action')">
      <!-- HEADER -->
      <template #header>
        <section class="comment-wrapper__comment__header">
          <div class="comment-wrapper__comment__user-info">
            ...
            <n-dropdown placement="bottom-start" trigger="click" size="small" :options="contentOptions"
              @select="handleSelect">
