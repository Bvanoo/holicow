...
const router = createRouter({
  ...
  routes: [
    ...
    {
      name: 'sub problems',
      path: '/sousproblemes/:data(\\d+)*', //(\\d+)* Permet de passer des tableaux string via router.push() avec les params de vuejs
...
//Avant chaque changement de route, on vérifie si le store est hydraté
router.beforeEach(async (to, from) => {
  ...
  //Blocage du nouvel utilisateur si son profil n'est pas complet
