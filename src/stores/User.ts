...
export const useUserStore = defineStore('userStore', {
  ...
  actions: {
    ...
    /**Permet de mettre le profil de l'utilisateur dans le userStore et d'affecter les booleans de vérification ainsi que la région */
    async hydrateApp() {
      ...
      if (firstLoginPayload) {
        ...
        //Vérification pour le firstConnexion
        if (userProfile?.region === '') this.isNewProfil = true
